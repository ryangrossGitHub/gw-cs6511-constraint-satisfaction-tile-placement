...
# '1' represents placing an outer_boundary tile at location 0
# '2' represents placing an el_shape tile at location 0
# '123' represents outer_boundary tile on 4x4 area 0, el_shape on 4x4 area 1, full_block on area 2
# '333' represents full_block tile on 4x4 area 0, full_block on 4x4 area 1, full_block on area 2
...
def get_next_value(variable):
    ...
    if current_state + next_value in visited_states:
